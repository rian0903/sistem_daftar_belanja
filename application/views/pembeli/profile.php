<div class="max-w-2xl mx-auto bg-white shadow-lg rounded-lg p-6 mt-6">
  <h2 class="text-2xl font-bold text-gray-800 mb-4">Profil Pembeli</h2>
  ...
  <div class="flex gap-4">
    ...
    <a href="<?= base_url('auth/logout') ?>" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded shadow">
      Logout
    </a>
  </div>

  <!-- Form Edit Profil -->
  <form action="<?= base_url('pembeli/update_profile') ?>" method="post" class="mt-6 hidden" id="editForm">
  ...
  <!-- Form Reset Password -->
  <form action="<?= base_url('pembeli/reset_password') ?>" method="post" class="mt-6 hidden" id="resetForm">
